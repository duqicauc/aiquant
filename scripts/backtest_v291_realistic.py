...
def main():
    ...
    parser.add_argument("--prediction-dir", default="data/prediction/v291_stk_factor", help="预测结果目录")
    parser.add_argument("--output-dir", default=str(OUTPUT_DIR / "v291_realistic"), help="输出目录")
    ...
    parser.add_argument("--stop-loss", type=float, default=10.0, help="止损百分比 (Phase 2 优化: 10%)")
    parser.add_argument("--trailing-stop", type=float, default=2.0, help="移动止盈回撤百分比 (Phase 2 优化: 2%)")

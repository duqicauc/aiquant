...
def main():
    ...
    parser.add_argument("--skip-prediction", action="store_true", help="跳过预测步骤，直接比对已有结果")
    parser.add_argument("--skip-comparison", action="store_true", help="跳过比对步骤，只进行预测")

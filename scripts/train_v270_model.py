...
def load_training_data():
    ...
    # 检查扩展硬负样本
    extended_hard_neg = PROJECT_ROOT / 'data' / 'training' / 'features' / 'hard_negative_feature_data_34d_v5_extended.csv'
...
def main():
    ...
    # 3. 检查风险特征
    risk_features = ['max_drawdown_10d', 'max_drawdown_20d', 'max_drawdown_55d',
                     'atr_14', 'atr_ratio_14', 'atr_expansion',
                     'days_from_high_20d', 'days_from_high_55d', 'recovery_ratio_20d']

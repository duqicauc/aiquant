...
def analyze_feature_importance():
    ...
    df = pd.read_csv(PROJECT_ROOT / 'data' / 'models' / 'breakout_launch_scorer' / 'versions' / 'v2.5.1' / 'feature_importance_v251.csv')
...
def main():
    ...
    # 保存分析结果
    output_file = PROJECT_ROOT / 'data' / 'models' / 'breakout_launch_scorer' / 'versions' / 'v2.5.1' / 'optimization_analysis.md'

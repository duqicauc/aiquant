...
def main():
    ...
    for holding in holdings:
        result = analyze_holding_with_pnl(holding["code"], holding["name"], holding["pnl"], stop_loss_pct, checker)

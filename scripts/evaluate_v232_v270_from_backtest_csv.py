...
def main():
    ...
    df_sell.to_csv(
        OUTPUT_DIR / "v232_v270_eval_by_source_20260105_20260303_detail.csv", index=False, encoding="utf-8-sig"
    )
    df_summary.to_csv(
        OUTPUT_DIR / "v232_v270_eval_by_source_20260105_20260303_summary.csv", index=False, encoding="utf-8-sig"
    )
    ...
    with open(md_path, "w", encoding="utf-8") as f:
        ...
        f.write(
            "**说明**：根据回测操作记录与互补策略 CSV 的 `source` 字段，统计「来自 v2.3.2 的标的」与「来自 v2.7.0 的标的」在**实际被卖出**时的盈亏。\n\n"
        )

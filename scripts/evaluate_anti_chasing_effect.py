...
def analyze_feature_importance():
    ...
    # v2.4.0新增特征
    new_features = [
        'price_range_34d', 'close_vs_ma10_std', 'days_near_ma10',
        'volume_shrink_ratio', 'price_vs_34d_high', 'price_vs_34d_low',
        'price_position_34d', 'volatility_34d'
    ]
...
def main():
    ...
    v24_predictions = PROJECT_ROOT / 'data' / 'models' / 'breakout_launch_scorer' / 'versions' / 'v2.4.0' / 'prediction' / 'results'

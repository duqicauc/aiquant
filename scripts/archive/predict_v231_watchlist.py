...
def main():
    ...
    with ThreadPoolExecutor(max_workers=10) as executor:
        ...
        for _, row in watchlist.iterrows():
            ...
            future = executor.submit(
                process_single_stock, dm, ts_code, name, predict_date, feature_names, booster, calibrator
            )
    ...
    if len(triggered) > 0:
        ...
        # 显示接近触发的股票
        near_trigger = df_results[df_results["calibrated_probability"] >= threshold - 0.1].sort_values(

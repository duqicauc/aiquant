...
def run_simple_backtest():
    ...
    # 添加策略
    cerebro.addstrategy(MLStrategy, buy_threshold=0.7, sell_threshold=0.3, printlog=True)
    ...
    # 添加分析器
    cerebro.addanalyzer(bt.analyzers.SharpeRatio, _name="sharpe", riskfreerate=0.03)  # 无风险利率3%
...
def run_parameter_optimization():
    ...
    cerebro.optstrategy(MLStrategy, buy_threshold=[0.6, 0.7, 0.8], sell_threshold=[0.2, 0.3, 0.4], printlog=False)
    ...
    for result in results:
        ...
        print(
            f"买入阈值: {strat.params.buy_threshold:.1f}, "

...
Usage:
    python scripts/train_v295_ensemble.py
"""
...
def load_training_data():
    """加载 v295 训练数据（统一特征提取版本）"""
    log.info("加载 v295 训练数据...")

    pos_file = PROJECT_ROOT / "data" / "training" / "v295" / "positive_features.csv"
    neg_file = PROJECT_ROOT / "data" / "training" / "v295" / "negative_features.csv"
    hard_file = PROJECT_ROOT / "data" / "training" / "v295" / "hard_negative_features.csv"

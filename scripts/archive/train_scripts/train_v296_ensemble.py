...
Usage:
    python scripts/train_v296_ensemble.py
"""
...
def load_training_data():
    """加载 v296 训练数据（含时间序列聚合特征）"""
    log.info("加载 v296 训练数据...")

    pos_file = PROJECT_ROOT / "data" / "training" / "v296" / "positive_features.csv"
    neg_file = PROJECT_ROOT / "data" / "training" / "v296" / "negative_features.csv"
    hard_file = PROJECT_ROOT / "data" / "training" / "v296" / "hard_negative_features.csv"

...
def analyze_stock(ts_code, predict_date="20260107"):
    ...
    # 技术指标
    tech_features = ["rsi_6", "rsi_12", "rsi_24", "kdj_k", "kdj_d", "kdj_j", "macd", "macd_dif", "macd_dea"]
    ...
    # 动量特征
    momentum_features = ["momentum_5d", "momentum_10d", "momentum_20d", "momentum_strength", "momentum_acceleration"]
    ...
    # 风险特征
    risk_features = ["max_drawdown_20d", "atr_ratio_14", "volatility_34d"]

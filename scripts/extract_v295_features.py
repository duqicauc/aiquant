...
Usage:
    python scripts/extract_v295_features.py
...
Output:
    data/training/v295/positive_features.csv
    data/training/v295/negative_features.csv
    data/training/v295/hard_negative_features.csv
"""
...
OUTPUT_DIR = PROJECT_ROOT / "data" / "training" / "v295"

...
Usage:
    python scripts/extract_v296_features.py
...
Output:
    data/training/v296/positive_features.csv
    data/training/v296/negative_features.csv
    data/training/v296/hard_negative_features.csv
"""
...
OUTPUT_DIR = PROJECT_ROOT / "data" / "training" / "v296"

...
class TestTushareFetcher:
    ...
    def test_get_daily_data(self, fetcher):
        ...
        df = fetcher.get_daily_data(stock_code=stock_code, start_date=start_date, end_date=end_date)
    ...
    def test_get_weekly_data(self, fetcher):
        ...
        df = fetcher.get_weekly_data(stock_code=stock_code, start_date=start_date, end_date=end_date)
    ...
    def test_get_minute_data(self, fetcher):
        ...
        df = fetcher.get_minute_data(stock_code=stock_code, freq="5min", start_date=start_date, end_date=end_date)
    ...
    def test_get_daily_data_empty_result(self, fetcher):
        ...
        # 使用一个不存在的股票代码（如果可能）
        # 或者使用一个很久以前的日期
        result = fetcher.get_daily_data(stock_code="999999.SZ", start_date="20000101", end_date="20000131")
        # 应该返回空DataFrame或抛出异常

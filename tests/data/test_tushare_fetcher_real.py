...
class TestTushareFetcherReal:
    ...
    def test_get_daily_data_real(self):
        ...
        result = dm.get_daily_data(
            stock_code="000001.SZ", start_date=start_date.strftime("%Y%m%d"), end_date=end_date.strftime("%Y%m%d")
        )
    ...
    def test_get_trade_calendar_real(self):
        ...
        result = dm.get_trade_calendar(start_date=start_date.strftime("%Y%m%d"), end_date=end_date.strftime("%Y%m%d"))
    ...
    def test_batch_get_daily_data_real(self):
        ...
        result = dm.batch_get_daily_data(
            stock_codes=stock_codes, start_date=start_date.strftime("%Y%m%d"), end_date=end_date.strftime("%Y%m%d")
        )

...
class TestDataManager:
    ...
    def test_get_daily_data(self, mock_data_manager):
        """测试获取日线数据"""
        result = mock_data_manager.get_daily_data(stock_code="000001.SZ", start_date="20240101", end_date="20240131")
        assert isinstance(result, pd.DataFrame)
        assert len(result) > 0
    ...
    def test_get_complete_data(self, mock_data_manager):
        ...
        result = mock_data_manager.get_complete_data(stock_code="000001.SZ", start_date="20240101", end_date="20240101")
        assert isinstance(result, pd.DataFrame)
    ...
    def test_get_weekly_data(self, mock_data_manager):
        ...
        result = mock_data_manager.get_weekly_data(stock_code="000001.SZ", start_date="20240101", end_date="20240105")
        assert isinstance(result, pd.DataFrame)
    ...
    def test_get_daily_basic(self, mock_data_manager):
        ...
        result = mock_data_manager.get_daily_basic(stock_code="000001.SZ", start_date="20240101", end_date="20240101")
        assert isinstance(result, pd.DataFrame)
    ...
    def test_get_stk_factor(self, mock_data_manager):
        ...
        result = mock_data_manager.get_stk_factor(stock_code="000001.SZ", start_date="20240101", end_date="20240101")
        assert isinstance(result, pd.DataFrame)
    ...
    def test_get_trade_calendar(self, mock_data_manager):
        ...
        result = mock_data_manager.get_trade_calendar(start_date="20240101", end_date="20240131")
        assert isinstance(result, pd.DataFrame)
    ...
    def test_batch_get_daily_data(self, mock_data_manager):
        ...
        result = mock_data_manager.batch_get_daily_data(
            stock_codes=stock_codes, start_date="20240101", end_date="20240101"
        )

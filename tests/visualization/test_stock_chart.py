...
class TestStockChartVisualizer:
    ...
    def sample_report(self):
        """示例体检报告"""
        return {
            "basic_info": {"name": "测试股票", "ts_code": "000001.SZ"},
            "overall_score": 7.5,
            "recommendation": "买入",
            "technical_analysis": {"trend": {"alignment_score": 8.0}, "volume_analysis": {"pv_score": 7.0}},
            "fundamental_analysis": {"financial_score": 6.5},
            "model_prediction": {"score": 7.8},
            "risk_assessment": {"risk_score": 6.0},
        }
    ...
    def test_create_comprehensive_chart_success(self, visualizer, sample_report):
        """测试成功创建综合图表"""
        fig = visualizer.create_comprehensive_chart(stock_code="000001.SZ", report=sample_report, days=120)
    ...
    def test_create_indicators_heatmap_minimal_report(self, visualizer):
        """测试使用最小报告创建热力图"""
        minimal_report = {"technical_analysis": {"trend": {"alignment_score": 5.0}}}

...
class TestPositiveSampleScreener:
    ...
    def test_screen_all_stocks_basic(self, mock_dm):
        ...
        result = screener.screen_all_stocks(start_date="20240101", end_date="20240131")
    ...
    def test_check_three_week_pattern_valid(self, mock_dm):
        ...
        result = screener._check_three_week_pattern(three_weeks, "000001.SZ", "测试股票", list_date)
    ...
    def test_screen_single_stock(self, mock_dm):
        ...
        list_date = pd.Timestamp("20200101")
        result = screener._screen_single_stock("000001.SZ", "测试股票", list_date, "20240101", "20240131")

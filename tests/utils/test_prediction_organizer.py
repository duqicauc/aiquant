...
from src.utils.prediction_organizer import archive_prediction_to_history, update_history_index, clean_old_results
...
class TestPredictionOrganizer:
    ...
    @pytest.mark.unit
    def test_archive_prediction_to_history_success(self, temp_result_dir, temp_history_dir, sample_prediction_files):
        """测试成功归档预测结果"""
    ...
    def test_update_history_index_new(self, temp_history_dir):
        ...
        update_history_index(
            model_name="test_model", prediction_date="20241226", history_path=history_path, files=files
        )
    ...
    def test_update_history_index_existing(self, temp_history_dir):
        ...
        # 更新索引
        update_history_index(
            model_name="test_model", prediction_date="20241226", history_path=history_path, files=["file2.txt"]
        )
    ...
    def test_clean_old_results(self, temp_result_dir):
        ...
        # 清理7天前的文件
        removed_count = clean_old_results(model_name="test_model", keep_days=7, result_dir=str(temp_result_dir))
    ...
    def test_clean_old_results_nonexistent_dir(self, temp_dir):
        ...
        removed_count = clean_old_results(
            model_name="test_model", keep_days=7, result_dir=str(temp_dir / "nonexistent")
        )
    ...
    def test_archive_with_default_paths(self, temp_dir):
        ...
        try:
            result = archive_prediction_to_history(model_name="test_model", prediction_date="20241226")

...
from src.backtest.data_feed import TushareData, DataFeedManager, create_data_feed
...
class TestDataFeedManager:
    ...
    def test_get_data_feed_success(self, data_feed_manager, mock_data_manager):
        """测试成功获取数据Feed"""
        feed = data_feed_manager.get_data_feed(stock_code="000001.SZ", start_date="20240101", end_date="20241231")
...
class TestCreateDataFeed:
    ...
    def test_create_data_feed(self, mock_manager_class):
        ...
        mock_manager.get_data_feed.assert_called_once_with("000001.SZ", "20240101", "20241231")

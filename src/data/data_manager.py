...
class DataManager:
    ...
    def get_daily_data(self, stock_code: str, start_date: str, end_date: str, adjust: str = "qfq") -> pd.DataFrame:
        """
        获取日线数据
        ...
        Returns:
            日线数据DataFrame
        """
        cache_key_params = {"ts_code": stock_code, "start_date": start_date, "end_date": end_date, "adjust": adjust}
        ...
        # 从API获取
        df = self.fetcher.get_daily_data(stock_code=stock_code, start_date=start_date, end_date=end_date, adjust=adjust)
    ...
    def get_weekly_data(self, stock_code: str, start_date: str, end_date: str, adjust: str = "qfq") -> pd.DataFrame:
        """
        获取周线数据
        ...
        # 从API获取
        df = self.fetcher.get_weekly_data(ts_code=stock_code, start_date=start_date, end_date=end_date, adjust=adjust)
    ...
    def get_daily_basic(
        self, stock_code: str = None, trade_date: str = None, start_date: str = None, end_date: str = None
    ) -> pd.DataFrame:
        """
        获取每日指标（市值、市盈率、换手率等）
    ...
    def get_stk_factor(self, stock_code: str, start_date: str, end_date: str) -> pd.DataFrame:
        """
        ...
        Returns:
            技术因子DataFrame
        """
        cache_key_params = {"ts_code": stock_code, "start_date": start_date, "end_date": end_date}
        ...
        # 从API获取
        df = self.fetcher.get_stk_factor(ts_code=stock_code, start_date=start_date, end_date=end_date)
    ...
    def get_complete_data(self, stock_code: str, start_date: str, end_date: str = None) -> pd.DataFrame:
        """
        获取完整数据（行情 + 每日指标 + 技术因子）
        ...
        # 2. 获取每日指标
        try:
            df_basic = self.get_daily_basic(stock_code=stock_code, start_date=start_date, end_date=end_date)
            ...
            if not df_basic.empty:
                ...
                # 合并（保留日线数据的所有行）
                merge_cols = [c for c in df_basic.columns if c not in df_daily.columns or c == "trade_date"]
                df_daily = pd.merge(df_daily, df_basic[merge_cols], on="trade_date", how="left")
    ...
    def get_suspend_info(self, ts_code: str = None, trade_date: str = None, suspend_type: str = None) -> pd.DataFrame:
        ...
        Returns:
            停牌信息DataFrame
        """
        return self.fetcher.get_suspend_info(ts_code=ts_code, trade_date=trade_date, suspend_type=suspend_type)
    ...
    def get_trade_calendar(self, start_date: str, end_date: str) -> pd.DataFrame:
        ...
        Returns:
            交易日历DataFrame
        """
        cache_key_params = {"start_date": start_date, "end_date": end_date}
    ...
    def batch_get_daily_data(
        self, stock_codes: List[str], start_date: str, end_date: str, adjust: str = "qfq"
    ...
    def get_index_daily(self, ts_code: str, start_date: str, end_date: str) -> pd.DataFrame:
        ...
        Returns:
            指数日线数据DataFrame
        """
        cache_key_params = {"ts_code": ts_code, "start_date": start_date, "end_date": end_date}
    ...
    def get_market_factors(
        ...
        return mf.enrich_stock_data_with_market_factors(stock_data, index_code, window)
